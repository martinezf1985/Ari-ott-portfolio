...
const PhotoCarousel: React.FC = () => {
  ...
  return (
    <div className="relative w-full max-w-sm sm:max-w-2xl md:max-w-4xl mx-auto bg-black rounded-2xl shadow-2xl overflow-hidden aspect-square sm:aspect-[4/3] md:aspect-[3/4]">
      <Swiper
        spaceBetween={30}
        centeredSlides
